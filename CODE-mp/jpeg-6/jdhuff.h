...
typedef struct {
  ...
  JINT32 mincode[17];		/* smallest code of length k */
  JINT32 maxcode[18];		/* largest code of length k (-1 if none) */
...
typedef JINT32 bit_buf_type;	/* type of bit-extraction buffer */
