...
#else
typedef JINT32 DCTELEM;		/* must have 32 bits */
#endif
...
#else
typedef JINT32 IFAST_MULT_TYPE;	/* need 32 bits for scaled quantizers */
...
#define MULTIPLY16C16(var,const)  (((INT16) (var)) * ((JINT32) (const)))
#endif
