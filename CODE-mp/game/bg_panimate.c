...
qboolean BG_InSpecialJump( int anim ) {
	if (demo15detected) {
		...
		case BOTH_WALL_RUN_RIGHT_FLIP_15:
		case BOTH_WALL_RUN_LEFT_15:
		case BOTH_WALL_RUN_LEFT_FLIP_15:
		case BOTH_WALL_FLIP_RIGHT_15:
		case BOTH_WALL_FLIP_LEFT_15:
		case BOTH_FLIP_BACK1_15:
		case BOTH_FLIP_BACK2_15:
		case BOTH_FLIP_BACK3_15:
		case BOTH_WALL_FLIP_BACK1_15:
		case BOTH_BUTTERFLY_LEFT_15:
		case BOTH_BUTTERFLY_RIGHT_15:
			return qtrue;
		}
		return qfalse;
	} else {
...
qboolean BG_InSaberStandAnim( int anim ) {
	if (demo15detected) {
		switch ( (anim&~ANIM_TOGGLEBIT) ) {
		case BOTH_SABERFAST_STANCE_15:
		case BOTH_STAND2_15:
		case BOTH_SABERSLOW_STANCE_15:
			return qtrue;
		default:
			return qfalse;
		}
...
qboolean BG_DirectFlippingAnim( int anim ) {
	if (demo15detected) {
		switch ( (anim&~ANIM_TOGGLEBIT) ) {
		case BOTH_FLIP_F_15:			//# Flip forward
		case BOTH_FLIP_B_15:			//# Flip backwards
		case BOTH_FLIP_L_15:			//# Flip left
		case BOTH_FLIP_R_15:			//# Flip right
			return qtrue;
			break;
		}
		return qfalse;
...
qboolean BG_FlippingAnim( int anim ) {
	if (demo15detected) {
		...
		case BOTH_WALL_RUN_RIGHT_15:
		case BOTH_WALL_RUN_LEFT_15:
		case BOTH_WALL_RUN_RIGHT_STOP_15:
		case BOTH_WALL_RUN_LEFT_STOP_15:
		case BOTH_BUTTERFLY_LEFT_15:
		case BOTH_BUTTERFLY_RIGHT_15:
		//
		case BOTH_ARIAL_LEFT_15:
		case BOTH_ARIAL_RIGHT_15:
		case BOTH_ARIAL_F1_15:
		case BOTH_CARTWHEEL_LEFT_15:
		case BOTH_CARTWHEEL_RIGHT_15:
		case BOTH_JUMPFLIPSLASHDOWN1_15:
		case BOTH_JUMPFLIPSTABDOWN_15:
			return qtrue;
			break;
		}
		return qfalse;
...
qboolean BG_SpinningSaberAnim( int anim ) {
	if (demo15detected) {
		...
		case BOTH_T1_BR_BL_15:
		case BOTH_T1__R__L_15:
		case BOTH_T1__R_BL_15:
		case BOTH_T1_TR_BL_15:
		case BOTH_T1_BR_TL_15:
		case BOTH_T1_BR__L_15:
		case BOTH_T1_TL_BR_15:
		case BOTH_T1__L_BR_15:
		case BOTH_T1__L__R_15:
		case BOTH_T1_BL_BR_15:
		case BOTH_T1_BL__R_15:
		case BOTH_T1_BL_TR_15:
		//level 2
		case BOTH_T2_BR__L_15:
		case BOTH_T2_BR_BL_15:
		case BOTH_T2__R_BL_15:
		case BOTH_T2__L_BR_15:
		case BOTH_T2_BL_BR_15:
		case BOTH_T2_BL__R_15:
		//level 3
		case BOTH_T3_BR__L_15:
		case BOTH_T3_BR_BL_15:
		case BOTH_T3__R_BL_15:
		case BOTH_T3__L_BR_15:
		case BOTH_T3_BL_BR_15:
		case BOTH_T3_BL__R_15:
		//level 4
		case BOTH_T4_BR__L_15:
		case BOTH_T4_BR_BL_15:
		case BOTH_T4__R_BL_15:
		case BOTH_T4__L_BR_15:
		case BOTH_T4_BL_BR_15:
		case BOTH_T4_BL__R_15:
		//level 5
		case BOTH_T5_BR_BL_15:
		case BOTH_T5__R__L_15:
		case BOTH_T5__R_BL_15:
		case BOTH_T5_TR_BL_15:
		case BOTH_T5_BR_TL_15:
		case BOTH_T5_BR__L_15:
		case BOTH_T5_TL_BR_15:
		case BOTH_T5__L_BR_15:
		case BOTH_T5__L__R_15:
		case BOTH_T5_BL_BR_15:
		case BOTH_T5_BL__R_15:
		case BOTH_T5_BL_TR_15:
		//special
		//case BOTH_A2_STABBACK1_15:
		case BOTH_ATTACK_BACK_15:
		case BOTH_CROUCHATTACKBACK1_15:
		case BOTH_BUTTERFLY_LEFT_15:
		case BOTH_BUTTERFLY_RIGHT_15:
		case BOTH_FJSS_TR_BL_15:
		case BOTH_FJSS_TL_BR_15:
		case BOTH_JUMPFLIPSLASHDOWN1_15:
		case BOTH_JUMPFLIPSTABDOWN_15:
			return qtrue;
			break;
...
qboolean BG_SaberInSpecialAttack( int anim ) {
	if (demo15detected) {
		...
		case BOTH_FJSS_TR_BL_15:
		case BOTH_FJSS_TL_BR_15:
		case BOTH_LUNGE2_B__T__15:
		case BOTH_FORCELEAP2_T__B__15:
		case BOTH_JUMPFLIPSLASHDOWN1_15://#
		case BOTH_JUMPFLIPSTABDOWN_15://#
			return qtrue;
		}
...
qboolean BG_InDeathAnim( int anim ) {
	if (demo15detected) {
		switch((anim&~ANIM_TOGGLEBIT)) {
		case BOTH_DIVE1_15:
		case BOTH_DEATHBACKWARD1_15:
		case BOTH_DEATHBACKWARD2_15:
		case BOTH_DEATHFORWARD1_15:
		case BOTH_DEATHFORWARD2_15:
		case BOTH_DEATH1_15:
		case BOTH_DEATH2_15:
		case BOTH_DEATH3_15:
		case BOTH_DEATH4_15:
		...
		case BOTH_DEATH1IDLE_15:
		case BOTH_LYINGDEATH1_15:
		case BOTH_STUMBLEDEATH1_15:
		case BOTH_FALLDEATH1_15:
		case BOTH_FALLDEATH1INAIR_15:
		case BOTH_FALLDEATH1LAND_15:
			return qtrue;
			break;
		default:
			return qfalse;
...
qboolean PM_InSaberAnim( int anim ) {
	if ( !demo15detected && (anim&~ANIM_TOGGLEBIT) >= BOTH_A1_T__B_ && (anim&~ANIM_TOGGLEBIT) <= BOTH_H1_S1_BR ) {
		return qtrue;
	} else if ( demo15detected && (anim&~ANIM_TOGGLEBIT) >= BOTH_A1_T__B__15 && (anim&~ANIM_TOGGLEBIT) <= BOTH_H1_S1_BR_15 ) {
		return qtrue;
	}
	return qfalse;
}
...
qboolean PM_PainAnim( int anim ) {
	if (demo15detected) {
		switch ( (anim&~ANIM_TOGGLEBIT) ) {
			case BOTH_PAIN1_15:				//# First take pain anim
			case BOTH_PAIN2_15:				//# Second take pain anim
			case BOTH_PAIN3_15:				//# Third take pain anim
			case BOTH_PAIN4_15:				//# Fourth take pain anim
			case BOTH_PAIN5_15:				//# Fifth take pain anim - from behind
			case BOTH_PAIN6_15:				//# Sixth take pain anim - from behind
			case BOTH_PAIN7_15:				//# Seventh take pain anim - from behind
			case BOTH_PAIN8_15:				//# Eigth take pain anim - from behind
			case BOTH_PAIN9_15:				//# 
			case BOTH_PAIN10_15:			//# 
			case BOTH_PAIN11_15:			//# 
			case BOTH_PAIN12_15:			//# 
...
qboolean PM_JumpingAnim( int anim ) {
	if (demo15detected) {
		switch ( (anim&~ANIM_TOGGLEBIT) ) {
			case BOTH_JUMP1_15:				//# Jump - wind-up and leave ground
			case BOTH_INAIR1_15:			//# In air loop (from jump)
			case BOTH_LAND1_15:				//# Landing (from in air loop)
			case BOTH_LAND2_15:				//# Landing Hard (from a great height)
			case BOTH_JUMPBACK1_15:			//# Jump backwards - wind-up and leave ground
			case BOTH_INAIRBACK1_15:		//# In air loop (from jump back)
			case BOTH_LANDBACK1_15:			//# Landing backwards(from in air loop)
			case BOTH_JUMPLEFT1_15:			//# Jump left - wind-up and leave ground
			case BOTH_INAIRLEFT1_15:		//# In air loop (from jump left)
			case BOTH_LANDLEFT1_15:			//# Landing left(from in air loop)
			case BOTH_JUMPRIGHT1_15:		//# Jump right - wind-up and leave ground
			case BOTH_INAIRRIGHT1_15:		//# In air loop (from jump right)
			case BOTH_LANDRIGHT1_15:		//# Landing right(from in air loop)
			case BOTH_FORCEJUMP1_15:				//# Jump - wind-up and leave ground
			case BOTH_FORCEINAIR1_15:			//# In air loop (from jump)
			case BOTH_FORCELAND1_15:				//# Landing (from in air loop)
			case BOTH_FORCEJUMPBACK1_15:			//# Jump backwards - wind-up and leave ground
			case BOTH_FORCEINAIRBACK1_15:		//# In air loop (from jump back)
			case BOTH_FORCELANDBACK1_15:			//# Landing backwards(from in air loop)
			case BOTH_FORCEJUMPLEFT1_15:			//# Jump left - wind-up and leave ground
			case BOTH_FORCEINAIRLEFT1_15:		//# In air loop (from jump left)
			case BOTH_FORCELANDLEFT1_15:			//# Landing left(from in air loop)
			case BOTH_FORCEJUMPRIGHT1_15:		//# Jump right - wind-up and leave ground
			case BOTH_FORCEINAIRRIGHT1_15:		//# In air loop (from jump right)
			case BOTH_FORCELANDRIGHT1_15:		//# Landing right(from in air loop)
			return qtrue;
			break;
		}
		return qfalse;
...
qboolean PM_InOnGroundAnim ( int anim ) {
	if (demo15detected) {
		...
		case BOTH_DEAD4_15:
		case BOTH_DEAD5_15:
		case BOTH_DEADFORWARD1_15:
		case BOTH_DEADBACKWARD1_15:
		case BOTH_DEADFORWARD2_15:
		case BOTH_DEADBACKWARD2_15:
		case BOTH_LYINGDEATH1_15:
		case BOTH_LYINGDEAD1_15:
		case BOTH_PAIN2WRITHE1_15:		//# Transition from upright position to writhing on ground anim
		case BOTH_WRITHING1_15:			//# Lying on ground writhing in pain
		case BOTH_WRITHING1RLEG_15:		//# Lying on ground writhing in pain_15: holding right leg
		case BOTH_WRITHING1LLEG_15:		//# Lying on ground writhing in pain_15: holding left leg
		case BOTH_WRITHING2_15:			//# Lying on stomache writhing in pain
		case BOTH_INJURED1_15:			//# Lying down_15: against wall - can also be sleeping
		case BOTH_CRAWLBACK1_15:			//# Lying on back_15: crawling backwards with elbows
		case BOTH_INJURED2_15:			//# Injured pose 2
		case BOTH_INJURED3_15:			//# Injured pose 3
		case BOTH_INJURED6_15:			//# Injured pose 6
		case BOTH_INJURED6ATTACKSTART_15:	//# Start attack while in injured 6 pose 
		case BOTH_INJURED6ATTACKSTOP_15:	//# End attack while in injured 6 pose
		case BOTH_INJURED6COMBADGE_15:	//# Hit combadge while in injured 6 pose
		case BOTH_INJURED6POINT_15:		//# Chang points to door while in injured state
		case BOTH_KNOCKDOWN1_15:		//# 
		case BOTH_KNOCKDOWN2_15:		//# 
			return qtrue;
			break;
...
animation_t	bgGlobalAnimations15[MAX_TOTALANIMATIONS_15];
...
qboolean BG_ParseAnimationFile(const char *filename) {
	...
	while(1) {
		...
		if (demo15detected)
			animNum = GetIDForString(animTable15, token);
		else
...
//#ifndef FINAL_BUILD
		...
		if (demo15detected)
			bgGlobalAnimations15[animNum].firstFrame = atoi( token );
		else
		...
		if (demo15detected)
			bgGlobalAnimations15[animNum].numFrames = atoi( token );
		else
		...
		if (demo15detected)
			bgGlobalAnimations15[animNum].loopFrames = atoi( token );
		else
		...
		if ( !demo15detected && fps < 0 ) {
			//backwards
			bgGlobalAnimations[animNum].frameLerp = floor(1000.0f / fps);
		} else if ( demo15detected && fps < 0 ) {
			//backwards
			bgGlobalAnimations15[animNum].frameLerp = floor(1000.0f / fps);
		} else if ( !demo15detected ) {
			bgGlobalAnimations[animNum].frameLerp = ceil(1000.0f / fps);
		} else if ( demo15detected ) {
			bgGlobalAnimations15[animNum].frameLerp = ceil(1000.0f / fps);
		}

		if (demo15detected)
			bgGlobalAnimations15[animNum].initialLerp = ceil(1000.0f / fabs(fps));
		else
...
void PM_StartTorsoAnim( int anim ) {
	...
	if (pm->ps->usingATST) { //animation is handled mostly client-side with only a few exceptions
		return;
	}
...
void BG_SaberStartTransAnim( int saberAnimLevel, int anim, float *animSpeed ) {
	if (demo15detected) {
		if ( ( (anim&~ANIM_TOGGLEBIT) >= BOTH_T1_BR__R_15 && 
			(anim&~ANIM_TOGGLEBIT) <= BOTH_T1_BL_TL_15 ) ||
			( (anim&~ANIM_TOGGLEBIT) >= BOTH_T2_BR__R_15 && 
			(anim&~ANIM_TOGGLEBIT) <= BOTH_T2_BL_TL_15 ) ||
			( (anim&~ANIM_TOGGLEBIT) >= BOTH_T3_BR__R_15 && 
			(anim&~ANIM_TOGGLEBIT) <= BOTH_T3_BL_TL_15 ) ) {
...
void PM_SetAnimFinal(int setAnimParts,int anim,int setAnimFlags, int blendTime) { // default blendTime=350
	...
	//not sure if we need to have that for compatibility with 1.02
	float editAnimSpeed = demo15detected?0:1;
...
void PM_SetAnim(int setAnimParts,int anim,int setAnimFlags, int blendTime) {	
	if (demo15detected)
		assert(	bgGlobalAnimations15[anim].firstFrame != 0 || bgGlobalAnimations15[anim].numFrames != 0);
	else
		assert(	bgGlobalAnimations[anim].firstFrame != 0 || bgGlobalAnimations[anim].numFrames != 0);

	if (BG_InSpecialJump(anim)) {
		setAnimFlags |= SETANIM_FLAG_RESTART;
	}

	if (BG_InRoll(pm->ps, pm->ps->legsAnim)) { //never interrupt a roll
		return;
	}
