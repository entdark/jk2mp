...
static qboolean captureParse( BG_XMLParse_t *parse, const struct BG_XMLParseBlock_s *fromBlock, void *data) {
...
static qboolean demoProjectSave( const char *baseName ) {
